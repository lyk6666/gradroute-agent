...
export const GRAPH_EDGES: RoutedEdge[] = [
  edge('e-student-intake', 'student_case', 'intake_context', undefined, 'conditional', ['right', 'left']),
  edge('e-intake-memory', 'intake_context', 'memory_retriever', undefined, 'conditional', ['right', 'left']),
  edge('e-memory-planner', 'memory_retriever', 'planner', undefined, 'conditional', ['right', 'left']),
  edge('e-planner-router', 'planner', 'supervisor_router'),
  ...
  edge('e-router-policy', 'supervisor_router', 'policy_agent', 'Policy', 'conditional', ['bottom', 'top'], [], { x: 835, y: 195 }),
  ...
  edge('e-policy-builder', 'policy_agent', 'resolution_builder'),
  ...
  edge('e-builder-pre', 'resolution_builder', 'pre_action_verifier'),
  edge('e-pre-action', 'pre_action_verifier', 'action_gate', 'Valid', 'conditional', ['bottom', 'top'], [], { x: 835, y: 586 }),
  edge('e-pre-planner', 'pre_action_verifier', 'planner', 'Replan', 'replan', ['right-top', 'right-bottom'], [{ x: 1270, y: 505 }, { x: 1270, y: 39 }], { x: 1260, y: 455 }),
  ...
  edge('e-clarify-planner', 'clarification', 'planner', 'Material change', 'replan', ['right-top', 'right'], [{ x: 1300, y: 375 }, { x: 1300, y: 27 }], { x: 1235, y: 305 }),
  ...
  edge('e-approval-planner', 'human_approval', 'planner', 'Rejected', 'danger', ['right-top', 'right-top'], [{ x: 1330, y: 645 }, { x: 1330, y: 15 }], { x: 1240, y: 584 }),
  ...
  edge('e-admin-final', 'human_admin_review', 'final_response', 'Handoff', 'conditional', ['right', 'left'], [{ x: 700, y: 657 }, { x: 700, y: 937 }], { x: 688, y: 858 }),
];
